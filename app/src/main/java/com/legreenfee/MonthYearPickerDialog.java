...
public class MonthYearPickerDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        this.monthPicker = (NumberPicker) dialog.findViewById(R.id.picker_month);
        this.yearPicker = (NumberPicker) dialog.findViewById(R.id.picker_year);
